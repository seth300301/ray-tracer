...
namespace RayTracer
{
    ...
    public readonly struct Vector3
    {
        ...
        {
            double productX = this.x * with.x;
            double productY = this.y * with.y;
            double productZ = this.z * with.z;
        ...
        {
            double productX = (this.y*with.z) - (this.z*with.y);
            double productY = - (this.x*with.z) + (this.z*with.x);
            double productZ = (this.x*with.y) - (this.y*with.x);
