...
namespace RayTracer
{
    ...
    public readonly struct Color
    {
        ...
        /// <summary>
        /// Deduct a color from another together component-wise.
        /// </summary>
        /// <param name="a">First color structure</param>
        /// <param name="b">Second color structure</param>
        /// <returns>Multiplied color structure</returns>
        ...
        /// <summary>
        /// Keeps all RGB values between 0.0 and 1.0.
        /// </summary>
        /// <returns>Clamped RGB values between 0.0 and 1.0 of the color</returns>
        public Color Clamp()
        {
            double R = this.R;
            double G = this.G;
            ...
            return new Color(Math.Clamp(R, 0.0, 1.0), Math.Clamp(G, 0.0, 1.0), Math.Clamp(B, 0.0, 1.0));
        }
    }
}
